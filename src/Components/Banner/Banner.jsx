...
const Banner = () => {
    return (
        <div>
            <div className="w-10/12 mx-auto p-10 text-center space-y-4 bg-gray-100 rounded-4xl mt-10 border-white border-3">
                <h1 className='font-bold text-6xl'>Dependable Care, Backed by Trusted <br />
                Professionals.</h1>
