...
const Doctor = ({doctor}) => {
    ...
    return (
            ...
            <div className='p-7 h-auto bg-cyan-50 rounded-xl space-y-3'>
                ...
                <Link to={`/doctorDetails/${id}`}><button className='px-30 py-2 border-1 border-cyan-500 cursor-pointer text-cyan-700 rounded-4xl hover:text-white hover:bg-cyan-700'>View Details</button></Link>
                </div>
            </div>
